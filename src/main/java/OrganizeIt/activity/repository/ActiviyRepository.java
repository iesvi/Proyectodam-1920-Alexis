...
public interface ActiviyRepository extends MongoRepository<Activity, String> {
    ...
    List<Activity> findByPublicaIsTrue();
    List<Activity> findByUsuariosContaining(String Email);
    List<Activity> findByUsuariosInvitadosContaining(String Email);
    List<Activity> findActivityByCreador(String Email);
